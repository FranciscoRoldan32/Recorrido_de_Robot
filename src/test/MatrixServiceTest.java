...
public class MatrixServiceTest {
	...
	private int[][] testMatrixEvenSteps, testMatrixOddSteps, matrixWithSolution, matrixWithoutSolution;
	...
	public void setUp() {
		...
		matrixWithSolution = new int[][] {
			{ 1, -1, 1 },
			{ -1, 1, -1 } 
			};

		matrixWithoutSolution = new int[][] { 
			{ 1, 1 },
			{ 1, 1 } 
			};
	}
	...
	@Test
	public void testRunAlgorithmWithoutSolution() {

		matrixService = new MatrixService(matrixWithoutSolution);
	...
	public void testRunAlgorithmWithSolution() {
		matrixService = new MatrixService(matrixWithSolution);
		ResultDto result = matrixService.runAlgorithm();
	...
	@Test
	public void testBacktrackCalls_sinPoda() {
		matrixService = new MatrixService(testMatrixEvenSteps);
		ResultDto result = matrixService.runAlgorithm();
	...
	@Test
	public void testBacktrackCalls_conPoda() {
		matrixService = new MatrixService(testMatrixEvenSteps);
		ResultDto result = matrixService.runAlgorithm();
